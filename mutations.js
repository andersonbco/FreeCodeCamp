...
return true because all of the letters in the 
second string are present in the first, ignoring 
case.
...
because all of the letters in "line" are present in 
"Alien". */
...
function mutation(arr) {
	...
	for(var i = 0; i < arr[1].length; i++)
		arrayChecker.push(arr[1].charAt(i));

	for(i = 0; i < arrayChecker.length; i++) {
		
		if(arr[0].toLowerCase().indexOf(arrayChecker[i].toLowerCase()) === -1) {
